<?php
	...
	if( !empty($this->pro_plugins) ) {
		...
		<div class="recom-plugin-info">
			<p><?php echo esc_html('Here are some free and premium plugins recommendation from us. You can build even better websites using these plugins.','ripple'); ?></p>
		</div>
				...
				<div class="recom-plugin-wrap">
					<div class="recom-plugin-inner-wrapper">
						...
						<div class="plugin-title-install clearfix">
							...
							<span class="plugin-action-btn plugin-btn-wrapper plugin-card-<?php echo esc_attr($plugin['slug']); ?>">
								<a class="view-detail"  href="<?php echo esc_attr($link); ?>"><?php echo esc_html__('View Detail', 'ripple');  ?></a>
							</span>
							<div class="version-author-info">
