	...
	class Ripple_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					...
					'actions_required' => esc_html__('Required Plugins', 'ripple'),
					'recommended_plugins' => esc_html__('Recommended Plugins', 'ripple'),
						...
						<div class="apwelcome-column-wrap">
							...
							<div class="apwelcome-column col-demos">
								...
								<div>
									...
									<?php printf( wp_kses_post( '<a class="options-page-btn notice-info-btn" href="%2$s">Or start setting up your theme now (without demo)!</a>', 'ripple' ), $this->theme_name, esc_url(admin_url( 'themes.php?page=welcome-page' ))  ); ?>

									<p><?php esc_html_e( 'You can also reach-out to us for any support during the theme setup and use.', 'ripple' ); ?></p>
							...
							<div class="apwelcome-column col-doc">
								...
								<div class="apwelcome-doc-btn">
									<a href="#" class=" button" ><span><?php esc_html_e( 'Return to your Dashboard', 'ripple' ); ?></span></a>
								</div>
							</div>
						</div>
					</div>
